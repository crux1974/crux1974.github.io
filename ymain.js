(function () {
            ...
            params: {
                ...
                emit: {
                    onCreate: function () {
                        ...
                        var descText = movie.overview || 'РћРїРёСЃ РІС–РґСЃСѓС‚РЅС–Р№.';
    ...
    function createSettings() {
        ...
        const rows =[
            { id: 'ym_row_movies_new', title: 'РќРѕРІРёРЅРєРё С„С–Р»СЊРјС–РІ', defOrder: '1' },
            { id: 'ym_row_movies_watch', title: 'РџРѕРїСѓР»СЏСЂРЅС– С„С–Р»СЊРјРё', defOrder: '2' },
            { id: 'ym_row_series_new', title: 'РќРѕРІРёРЅРєРё СЃРµСЂС–Р°Р»С–РІ', defOrder: '3' },
            { id: 'ym_row_series_pop', title: 'РџРѕРїСѓР»СЏСЂРЅС– СЃРµСЂС–Р°Р»Рё', defOrder: '4' },
            { id: 'ym_row_community', title: 'Р—РЅР°С…С–РґРєРё СЃРїС–Р»СЊРЅРѕС‚Рё LME', defOrder: '5' },
            { id: 'ym_row_random', title: 'Р’РёРїР°РґРєРѕРІР° РїС–РґР±С–СЂРєР°', defOrder: '6' }
        ];
        let orderValues = { '1': 'РџРѕР·РёС†С–СЏ 1', '2': 'РџРѕР·РёС†С–СЏ 2', '3': 'РџРѕР·РёС†С–СЏ 3', '4': 'РџРѕР·РёС†С–СЏ 4', '5': 'РџРѕР·РёС†С–СЏ 5', '6': 'РџРѕР·РёС†С–СЏ 6' };
    ...
    function overrideApi() {
        Lampa.Api.sources.tmdb.main = function (params, oncomplite, onerror) {
            var rowDefs =[
                { id: 'ym_row_movies_new', defOrder: 1, type: 'uas', url: 'uas_movies_new', loadUrl: 'https://uaserials.com/films/p/', title: 'РќРѕРІРёРЅРєРё С„С–Р»СЊРјС–РІ', icon: 'https://upload.wikimedia.org/wikipedia/commons/5/51/Ukraine_film_clapperboard.svg' },
                { id: 'ym_row_movies_watch', defOrder: 2, type: 'uas', url: 'uas_movies_pop', loadUrl: 'https://uaserials.my/filmss/w/', title: 'РџРѕРїСѓР»СЏСЂРЅС– С„С–Р»СЊРјРё', icon: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Filmreel-icon.svg' },
                { id: 'ym_row_series_new', defOrder: 3, type: 'uas', url: 'uas_series_new', loadUrl: 'https://uaserials.com/series/p/', title: 'РќРѕРІРёРЅРєРё СЃРµСЂС–Р°Р»С–РІ', icon: 'https://upload.wikimedia.org/wikipedia/commons/3/3a/Mplayer.svg' },
                { id: 'ym_row_series_pop', defOrder: 4, type: 'uas', url: 'uas_series_pop', loadUrl: 'https://uaserials.com/series/w/', title: 'РџРѕРїСѓР»СЏСЂРЅС– СЃРµСЂС–Р°Р»Рё', icon: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Tvfilm.svg' },
                { id: 'ym_row_community', defOrder: 5, type: 'community', url: 'uas_community', title: 'Р—РЅР°С…С–РґРєРё СЃРїС–Р»СЊРЅРѕС‚Рё LME', icon: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Anime_eye_film.png' },
                { id: 'ym_row_random', defOrder: 6, type: 'random', url: '', title: 'Р’РёРїР°РґРєРѕРІР° РїС–РґР±С–СЂРєР°', icon: 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Magicfilm_icon.svg' }
            ];
            ...
            if(parts_data.length === 0) {
                parts_data.push((cb) => loadRow('uas_movies_new', 'https://uaserials.com/films/p/', 'РќРѕРІРёРЅРєРё С„С–Р»СЊРјС–РІ', cb));
            }
